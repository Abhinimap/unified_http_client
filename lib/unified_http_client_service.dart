    ...
    if (useHttp) {
      ...
      switch (type) {
        ...
        case _RequestType.patch:
          res = await PackageHttp.patchRequest(url: url, headers: headersMap, body: body);
          break;
      ...
      switch (type) {
        ...
        case _RequestType.put:
          ...
          break;
        case _RequestType.patch:
          res = await PackageDio.dioPatch(urlPath: endpoint, headers: headersMap, queryPara: queryPara, body: body);
          break;
        case _RequestType.delete:
...
enum _RequestType { get, post, put, patch, delete, multipart }
